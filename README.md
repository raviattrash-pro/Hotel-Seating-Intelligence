...
Here are the visual representations of the application's key modules. They demonstrate the design layout, glassmorphism UI, interactive floor-plan seat placements, and the real-time analytics widgets.

### 1. Customer Floor Plan Selector & Booking Form
The customer is presented with a visual grid overlay of the tables mapped directly onto the physical restaurant layout. They can view occupancy, select a preferred table, check zones, and finalize payments via UPI.
![Customer Seating Selector & Booking Form](./docs/images/floor_plan_mockup.png)

### 2. Admin Seating Setup & Analytics Dashboard
Admins can upload customized floor plans, place tables dynamically on coordinates, resize them with simple sliders, track utilization, verify transactions, and read queueing-theory signals.
![Admin Settings & Seating Dashboard](./docs/images/dashboard_mockup.png)

> [!NOTE]
> *To view these mockups locally in your workspace, run the following copy command in your terminal to transfer the generated high-fidelity images into the project folder:*
>
> **For PowerShell:**
> ```powershell
